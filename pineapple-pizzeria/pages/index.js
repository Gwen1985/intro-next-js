      ...
      <div>
        ...
        <header className={styles.header}>
          <div className="row">
            ...
            <div className="col-md-5 mt-2 d-flex justify-content-center">
            ...
            <div className="row">
              <div className="col-md-12 pt-2 d-flex justify-content-center">
                <div className={styles.bookingBtn}>
                  <Link href="/navigation/bookatable"><a className="btn btn-warning rounded-pill"
                                                         id={styles.bookingBtn}><p className="pt-2">Book a
                    table</p></a></Link>
                </div>
              </div>
            </div>
